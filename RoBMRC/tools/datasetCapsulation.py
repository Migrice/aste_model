...
class QueryAndAnswer:
    def __init__(self, line, forward_asp_query, forward_asp_prob,
forward_opi_query,forward_opi_prob,
                 ...
                 backward_asp_query, backward_asp_prob, backward_opi_query, backward_opi_prob, 
        ...
        self.forward_opi_prob = forward_opi_prob
        ...
        self.backward_asp_prob = backward_asp_prob
...
class ReviewDataset(Dataset):
    ...
    def __getitem__(self, item):
        dataset_to_numpy_array = {
            ...
            'forward_opi_prob' : np.array(self.dataset[item].forward_opinion_prob),
            ...
            'backward_asp_prob': np.array(self.dataset[item].backward_aspect_prob),
